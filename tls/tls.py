...
# Run to see failure
# for server: python3 tls.py -s localhost.pem '' 1060
# for client: python3 tls.py localhost 1060

# Run to see success
# for server: python3 tls.py -s localhost.pem '' 1060
# for client: python3 tls.py -a ca.crt localhost 1060

# to see encryption in action
# tcpdump -n port 1060 -i lo0 -X
